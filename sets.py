...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    for item in set(drink_ingredients):
        if item in ALCOHOLS:
...
def compile_ingredients(dishes):
    ...
    final_set = set()
    for item in dishes:
        individual_set = set(item)
        final_set = final_set | individual_set
    return final_set
...
def separate_appetizers(dishes, appetizers):
    ...
    clean_dishes_two = []
    for item in dishes:
        if item not in clean_dishes:
            clean_dishes.append(item)
    for item in clean_dishes:
        if item not in set(appetizers):
            clean_dishes_two.append(item)
    return clean_dishes_two
